...
class Blueprint
{
    ...
    {
        $this->dropColumn(Model::CREATIME, Model::UPDATIME);
    }
    ...
    /**
     * Add nullable creatime and upidatime timestamps to the table.
     *
     * @return void
     */
    public function timestamps()
    {
        $this->timestamp(Model::CREATIME)->nullable();

        $this->timestamp(Model::UPDATIME)->nullable();
    }

    /**
     * Add nullable creatime and updatime timestamps to the table.
     *
    ...
    /**
     * Add creatime and updatime timestampTz columns to the table.
     *
     * @return void
     */
    public function timestampsTz()
    {
        $this->timestampTz(Model::CREATIME)->nullable();

        $this->timestampTz(Model::UPDATIME)->nullable();
    }
