...
//			});
            ...
            closeBtn.bind("click", function () {
                ...
                stylespacing.width($(window).width() - (options.spacingw) - $sidebar.width()).addClass("Widescreen"); // 右侧表格
            ...
            showbtn.click(function () {
                ...
                stylespacing.width($(window).width() - (options.spacingh) - $sidebar.width() - 30).removeClass("Widescreen");
